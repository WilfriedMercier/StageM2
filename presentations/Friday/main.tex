...
\begin{frame}{First results}
	...
	\begin{columns}
		\begin{column}{0.7\linewidth}		
			\includegraphics[width=\linewidth]{{graphics/TFRz}.pdf}
		\end{column}
		\begin{column}{0.4\linewidth}
			\begin{itemize}[label=$\rhd$]
				\item First TFR obtained yesterday
				\item \textbf{still investigating}
				\item comparison with Eagle simulation (Schaye+15)
			\end{itemize}
		\end{column}
	\end{columns}
\end{frame}
