...
\begin{figure}[htbp]
	...
	\caption[Bias before/after correction]{Biais and scatter before and after applying the correction mentioned in the paragraph. The dashed line represents the relation if there was no bias. Left: half-light radius relative error as a function of Cassata's radius. Right: scaling between Cassata's and GALFIT radii. The scatter around $\SI{0.2}{px}$ is not significantly changed after the bias correction.}
